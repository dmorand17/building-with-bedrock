...
if upload_image_1:
    image_bytes = glib.get_bytes_from_file(APP_DIR / "images/minihouse.jpg")
    ...
    image_bytes = glib.get_bytes_from_file(APP_DIR / "images/house_and_car.jpg")
    glib.chat_with_model(
        message_history=st.session_state.chat_history,
        new_text=None,
        new_image_bytes=image_bytes,
    ...
    image_bytes = glib.get_bytes_from_file(APP_DIR / "images/minicar.jpg")
    glib.chat_with_model(
        message_history=st.session_state.chat_history,
        new_text=None,
        new_image_bytes=image_bytes,
