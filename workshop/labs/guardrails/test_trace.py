...
def invoke_nova_lite_with_guardrails(
    prompt, guardrail_id, guardrail_version, region="us-west-2"
):
    ...
    request_body = {
        ...
        "inferenceConfig": {"maxTokens": 500, "temperature": 0.7, "topK": 20},
    }
...
answer = invoke_nova_lite_with_guardrails(
    prompt, guardrail_id, guardrail_version, region="us-east-1"
)
print(answer)
